...
CWeapon::CWeapon(ITEM_STATU itemStatu , WEAPON_KIND weaponKind , fPoint pos)
{
	...
	switch (weaponKind)
	{
		...
		case WEAPON_KIND::DEFAULT_GUN:
			...
			m_sAttackInfo->m_fAniSize = fPoint(40, 20);
